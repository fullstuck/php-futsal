        ...
        <div class="container">
            <div class="row">
				...
				<a class="btn btn-success" href="list_harga_member.php"><i class="fa fa-reply "></i> Kembali ke Menu Sebelumnya</a></div>
					...
					<!-- Fungsi Menampilkan Data dari Database -->
							<?php
							$query = mysqli_query($koneksi, "SELECT * FROM tb_member WHERE id_member='$_GET[kd]'");
			...
			<div class="col-md-12 col-sm-12">
                    <div class="panel panel-danger">
						...
						<form action="update_list_member.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<div class="form-group">
                    <label class="control-label">ID Member</label>
                    <input class="form-control" style="width:10%" type="text" name="id_member" id="id_member" value="<?php echo $data['id_member'];?>" readonly="readonly" autofocus="on">
				  </div>	
                  <div class="form-group">
                    <label class="control-label">Jumlah Jam</label>
                    <input class="form-control" style="width:10%" type="text" name="jumlah_jam" id="jumlah_jam" value="<?php echo $data['jumlah_jam'];?>">
				  </div>
				  <div class="form-group">
