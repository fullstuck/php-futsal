        ...
        <div class="container">
            <div class="row">
				...
				<a class="btn btn-success" href="user.php"><i class="fa fa-reply "></i> Kembali ke Menu Sebelumnya</a></div>
                    <h4 class="page-head-line">Edit Data Admin</h4>
			...
			<div class="col-md-12 col-sm-12">
                    ...
                    <input class="form-control" style="width:10%" type="text" name="user_id" id="user_id" value="<?php echo $data['user_id'];?>" readonly="readonly" autofocus="on">
				  </div>	
                  <div class="form-group">
                    <label class="control-label">Username</label>
                    <input class="form-control" style="width:20%" type="text" name="username" id="username" value="<?php echo $data['username'];?>">
				  </div>
                  <div class="form-group">
                    <label class="control-label">Password</label>
                    <input class="form-control" style="width:25%" type="password" name="password" id="password" value="<?php echo $data['password'];?>">
                  </div>
				  <div class="form-group">
                    <label class="control-label">Nama Lengkap</label>
                    <input class="form-control" style="width:40%" type="text" name="fullname" id="fullname" value="<?php echo $data['fullname'];?>">
                  </div>
				  <div class="form-group">
                    <label class="control-label">No. HP</label>
				    <input class="form-control" style="width:20%" id="demoDate" type="text" name="no_hp" id="no_hp" value="<?php echo $data['no_hp'];?>">
				   </div>
				  <div class="form-group">
