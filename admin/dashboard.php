...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Welcome to Admin Dashboard</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-one">
                        <a href="transaksi.php"><i  class="fa fa-user-secret dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
							<div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
							</div>
                        </div>
                        <h5>Data Sewa Lapangan </h5>
                    </div>
                </div>
                 <div class="col-md-4 col-sm-4 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-one">
                       <!-- <i  class="fa fa-cogs dashboard-div-icon" ></i> -->
						<a href="list_harga.php"><i  class="fa fa-money dashboard-div-icon"></i></a>
                        <div class="progress progress-striped active">
                ...
                <div class="col-md-4 col-sm-4 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-three">
                        <a href="user.php"><i  class="fa fa-user dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
				...
				<div class="col-md-4 col-sm-4 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-four">
                        <a href="transaksi_member.php"><i  class="fa fa-user dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
							<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
							</div>
                        </div>
                        <h5>Data Pesan Member </h5>
                    </div>
                </div>
				<div class="col-md-4 col-sm-4 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-four">
                        <a href="list_harga_member.php"><i  class="fa fa-user dashboard-div-icon" ></i></a>
                        <div class="progress progress-striped active">
							<div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 50%">
							</div>
                        </div>
