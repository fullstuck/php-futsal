    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
              ...
              <div class="col-lg-4">
              <form action='list_harga.php' method="POST">
          
	       <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Nama Lapangan & Harga ' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='list_harga.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	</div>
              </div><p></p>
				
				<div align="right">	
				<a class="btn btn-primary" href="tambah_harga.php"><i class="fa fa-plus-square "></i> Tambah Data Harga </a></div>
                </div>
			...
			<!-- Fungsi Menampikan Isi dari Database -->
					<?php
                    $query1="select * from tb_lapangan order by id_lapangan DESC";
