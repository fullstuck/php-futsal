        ...
        <div class="container">
            <div class="row">
				...
				<a class="btn btn-danger" href="dashboard.php"><i class="fa fa-fast-backward "></i> Kembali ke Menu Utama</a></div>
                    <h4 class="page-head-line">Detail Admin</h4>
					<div align="right">	
                  ...
                  <thead>
                    ...
                    <!-- Menampilkan Hasil Data Detail Anggota dari Database -->                  
                      ...
                      <td rowspan="5"><div class="pull-right image">
                            <img src="<?php echo $data['gambar']; ?>" class="img-rounded" height="150" width="150"  alt="User Image" style="border: 2px solid #000;" />
                        </div></td>
                      </tr>
                      <tr>
                      ...
                      <a href="user.php" class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali </a>
					  <p></p>
					<!-- End -->
