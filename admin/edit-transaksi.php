        ...
        <div class="container">
            <div class="row">
				...
				<a class="btn btn-success" href="transaksi.php"><i class="fa fa-reply "></i> Kembali ke Menu Sebelumnya</a></div>
                    <h4 class="page-head-line">Edit Data Transaksi</h4>
					
					<!-- Fungsi Menampilkan Data dari Database -->
					<?php
					$kd = $_GET['kd'];
					$sql = mysqli_query($koneksi, "SELECT * FROM tb_transaksi a JOIN tb_lapangan b ON a.id_lapangan=b.id_lapangan WHERE id_transaksi='$kd'");
					...
					if(isset($_POST['update'])){
						...
						$update = mysqli_query($koneksi, "UPDATE tb_transaksi SET  nama='$nama', tgl_main='$tgl_main', id_lapangan='$id_lapangan', 
						hari_main='$hari_main', jam_mulai='$jam_mulai', jam_selesai='$jam_selesai', keterangan='$keterangan' WHERE id_transaksi='$id_transaksi'") or die(mysqli_error());
						if($update){
			...
			<div class="col-md-12 col-sm-12">
                    ...
                    <input class="form-control" style="width:10%" type="text" name="id_transaksi" id="id_transaksi" value="<?php echo $row['id_transaksi'];?>" readonly="readonly" autofocus="on">
				  </div>
				  
                  <div class="form-group">
                    <label class="control-label">Nama Pemesan</label>
                    <input class="form-control" style="width:30%" id="nama" type="text" name="nama" value="<?php echo $row['nama'];?>">
				   </div>
				   <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input name="tgl_main" style="width:25%" id="tgl_main" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" type="text" value="<?php echo $row['tgl_main'];?>" required />  
				</div>
				  <div class="form-group">
                    <label class="control-label">Nama Lapangan</label> &nbsp;&nbsp;&nbsp;&nbsp; "Pastikan Anda Sudah Melihat <b>List Harga</b> Lapangan Terlebih Dahulu & Bagi Yang Ingin Menjadi Member Silahkan <b>Pilih Paket Member</b>"
                              <select name="id_lapangan" style="width:30%" class="form-control" required>
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
                    <label class="control-label">Bukti Pembayaran</label> <b>Transaksi Booking</b>*
                    <img src="<?php echo $row['gambar'];?>" width="200" height="250" class="img-rounded" style="border: 3px solid #888;"/>
                 </div>

				  
				  <div class="card-footer">
                <button class="btn btn-primary icon-btn" name="update" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Simpan</button>
