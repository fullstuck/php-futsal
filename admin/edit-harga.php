    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
				...
				<a class="btn btn-success" href="list_harga.php"><i class="fa fa-reply "></i> Kembali ke Menu Sebelumnya</a></div>
                    <h4 class="page-head-line">Edit Data Harga</h4>
					
					<!-- Fungsi Menampilkan Data dari Database -->
							<?php
							$query = mysqli_query($koneksi, "SELECT * FROM tb_lapangan WHERE id_lapangan='$_GET[kd]'");
			...
			<div class="col-md-12 col-sm-12">
                    <div class="panel panel-danger">
						...
						<form action="update-list.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<div class="form-group">
                    <label class="control-label">ID Lapangan</label>
                    <input class="form-control" style="width:10%" type="text" name="id_lapangan" id="id_lapangan" value="<?php echo $data['id_lapangan'];?>" readonly="readonly" autofocus="on">
				  </div>	
                  <div class="form-group">
                    <label class="control-label">Nama Lapangan</label>
                    <input class="form-control" style="width:40%" type="text" name="nama_lapangan" id="nama_lapangan" value="<?php echo $data['nama_lapangan'];?>">
				  </div>
				  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" style="width:15%" type="text" name="harga" id="harga" value="<?php echo $data['harga'];?>">
                  </div>
				  
				  <div class="card-footer">
                <button class="btn btn-primary icon-btn" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Simpan</button>
				&nbsp;&nbsp;&nbsp;<a class="btn btn-default icon-btn" href="list_harga.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
              </div>
