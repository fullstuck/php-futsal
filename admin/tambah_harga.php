        ...
        <div class="container">
				...
				<!-- Fungsi Memasukkan Data kedalam Database -->
					<?php
						if(isset($_POST['input'])){
							...
							$cek = mysqli_query($koneksi, "SELECT * FROM tb_lapangan WHERE nama_lapangan='$nama_lapangan'");
							if(mysqli_num_rows($cek) == 0){
									$insert = mysqli_query($koneksi, "INSERT INTO tb_lapangan(nama_lapangan, waktu, harga)
																		VALUES('$nama_lapangan','$waktu','$harga')") 
																		or die(mysqli_error());
									if($insert){
								...
								echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Lapangan Sudah Ada..!</div>';
							}
						}
						?>
					<!-- End -->	
			...
			<div class="col-md-12 col-sm-12">
                    <div class="panel panel-danger">
						...
						<form action="tambah_harga.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
