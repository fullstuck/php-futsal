        ...
        <div class="container">
            <div class="row">
				...
				<!-- <a class="btn btn-success" href="cetak-lapangan.php"><i class="fa fa dekstop "></i> Cetak List Harga</a></div> -->
                    <h4 class="page-head-line">List Pesanan</h4>
					
					 <!-- Small boxes (Stat box) -->
                    <div class="row">
                    
              <div class="col-lg-4">
              <form action='status_pesanan.php' method="POST">
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-success">
                        Berikut Daftar Lapangan yang Telah Anda Pesan
						</div>
                </div>
			...
			<!-- Fungsi Menampikan Isi dari Database -->
                    ...
                    $query1="SELECT a.nama_lapangan, b.id_pesanan, b.harga, b.tgl, b.jam, b.status, b.gambar FROM tb_lapangan a, tb_pemesanan b where a.id_lapangan=b.id_lapangan AND b.user_id='$user_id'";

                    
					// Fungsi Search
                    if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	               $query1="SELECT a.nama_lapangan, b.harga, b.tgl, b.jam, b.status, b.gambar FROM tb_lapangan a, tb_pemesanan b where a.id_lapangan=b.id_lapangan AND b.user_id='$user_id' AND b.tgl like '%$qcari%'";
                    }
						...
						--> 
						 <?php
							if($data['status']=="Diterima" && $data['gambar']==null){
								?>
								<td>
								<form class="form-horizontal style-form" action="insert-pembayaran.php?hal=edit&kd=<?php echo $data['id_pesanan'];?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
