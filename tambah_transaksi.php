    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
				...
				<a class="btn btn-success" href="booking.php"><i class="fa fa-reply "></i> Kembali ke Menu Sebelumnya</a></div>
			...
			<div class="col-md-12 col-sm-12">
                    <div class="panel panel-danger">
						...
						<form action="admin/insert-transaksi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
				  ...
				  <div class="form-group">
                    <label class="control-label">Nama Lapangan</label> &nbsp;&nbsp;&nbsp;&nbsp; "Pastikan Anda Sudah Melihat <b>List Harga</b> Lapangan Terlebih Dahulu & Bagi Yang Ingin Menjadi Member Silahkan <b>Pilih Paket Member</b>"
                              <select name="id_lapangan" style="width:30%" class="form-control" onchange="document.getElementById('harga').value = jumlah[this.value]" required>
						    ...
						    <?php $jsArray .= "jumlah['" . $data['id_lapangan'] . "'] = '" . addslashes($data['harga']) . "';\n";  } ?>
                              </select>
                  </div>
				...
				&nbsp;&nbsp;&nbsp;<a class="btn btn-default icon-btn" href="booking.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
              </div>
